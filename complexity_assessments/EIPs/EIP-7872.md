...
Link: https://eips.ethereum.org/EIPS/eip-7872
...
| **Performance risks** | 0  | This EIP helps avoid a performance risk when your bandwidth is limited. |
| **Security risks** |  0 |   |
...
|-----------|--------------|:----:|
| **Total Score** | Sum of all criterion scores (0–72) | **`0`** |
