...
Link: https://eips.ethereum.org/EIPS/eip-7668.md
...
| **New or modified transaction validity mechanisms** |   |   |
| **New block / header fields** | 1 | Block header field value is changed |
| **New fork activation mechanism** | 0 |   |
| **Performance risks** | 1 | `eth_getLogs` gets much slower - clients will have to check every single transaction receipt instead of just checking matching receipts/blocks |
| **Security risks** | 0 |   |
...
|-----------|--------------|:----:|
| **Total Score** | Sum of all criterion scores (0–72) | **`2`** |
