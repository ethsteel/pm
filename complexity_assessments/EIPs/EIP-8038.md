...
Link: https://eips.ethereum.org/EIPS/eip-8038
...
|---|---:|---|
| **EVM Gas rule changes** | 3 | Updated mechanism introduced to cold and warm account accesses |
| **Blob gas accounting changes** | 0 |   |
| **New EVM gas refund** | 1 | `GAS_STORAGE_CLEAR_REFUND` is modified. |
| **Patterns affecting pre-existing tests** | 3 | 11 opcodes affected  |
| **Transition-tool interface changes** |   |  |
| **Cryptography-related testing** | 0 |   |
| **Edge/boundary conditions** | 2 | Many edge-case and boundary condition prone mechanisms |
...
| **New or modified transaction validity mechanisms** | 2 | Access list cost change which affects type 1 and type 2 intrinsic gas. |
| **New block / header fields** | 0 |   |
| **New fork activation mechanism** | 0 |   |
| **Performance risks** | 3  | New values are unspecified, and the EIP does not have current benchmarking numbers yet |
| **Security risks** | 3 | Any time gas costs are modified introduces inherent risk. Better specification may bring this number down. |
| **Cross-EIP interactions** | 3 | Strong interactions with EIP-8032, EIP-2926, EIP-2929, EIP-2930/EIP-1559,and EIP-7928. |
