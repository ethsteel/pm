...
| **Added opcodes** | 0 |   |
| **Modified opcodes** | 0 | Final EVM semantics (gas charged, state changes, reverts) are unchanged. Only the observation order for BAL inclusion is constrained, which is a spec-framework concern, not a behavior change in the criterion's sense. |
| **Added precompiles** | 0 |   |
...
|-----------|--------------|:----:|
| **Total Score** | Sum of all criterion scores (0–72) | **`29`** |
