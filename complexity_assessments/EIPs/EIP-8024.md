...
Link: https://eips.ethereum.org/EIPS/eip-8024
...
| **Added opcodes** | 3 | Introduces 3 new opcodes  |
| **Modified opcodes** | 0 |   |
| **Added precompiles** | 0 |   |
...
| **Performance risks** | 1 | Performance may be impacted if a client implementation doesn't keep the whole stack in memory  |
| **Security risks** | 0 |   |
