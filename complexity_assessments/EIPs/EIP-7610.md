...
Link: https://eips.ethereum.org/EIPS/eip-7610.md
...
| **Patterns affecting pre-existing tests** | 3 | Some static tests might break as noted by Pawel in the magicians thread.  |
| **Transition-tool interface changes** | 2 | EELS might be updated to handle this EIP.   |
...
| **New or modified transaction validity mechanisms** | 2  | The EIP is an even stricter version of `684`, adding the rule that the storage also has to be empty.  |
| **New block / header fields** | 0 |  |
| **New fork activation mechanism** | 0 |   |
| **Performance risks** | 0 |  |
| **Security risks** | 0 | The EIP helps improve security.  |
