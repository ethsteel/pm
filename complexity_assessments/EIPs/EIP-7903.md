...
Link: https://eips.ethereum.org/EIPS/eip-7903
...
| **Patterns affecting pre-existing tests** | 0  | The change is backwards-compatible.  |
...
| **New or modified transaction validity mechanisms** | 1  | A transaction that previously would be invalid might be valid now.  |
| **New block / header fields** | 0  |   |
| **New fork activation mechanism** | 0  |   |
| **Performance risks** | 1  | There needs to be more benchmarking work done to compare performance of different clients under various large initcode scenarios.  |
| **Security risks** |  0 |   |
| **Cross-EIP interactions** | 3  | The proposed EIP is outdated in the sense that it conflicts with 7825 which was introduced in Fusaka. Even older EIPs like pectra's 7623 do something similar.  |
