...
Link: https://eips.ethereum.org/EIPS/eip-8051
...
| **Cryptography-related testing** | 3 + 3  | Cryptographically-related precompiles require exhaustive testing and performance benchmarking.  |
...
| **Added opcodes** | 0  |   |
| **Modified opcodes** | 0  |   |
| **Added precompiles** | 3 + 3  | This EIP adds 2 precompiles at once.  |
| **Modified precompiles** | 0  |   |
| **Encoding changes (RLP/SSZ)** | 0  |   |
| **New transaction types** | 0  |   |
| **New or modified transaction validity mechanisms** | 1 | A transaction is only valid when its signature is valid, if the proposed precompiles can be used to sign transactions then it affects tx validity mechanisms. |
| **New block / header fields** | 0 |   |
| **New fork activation mechanism** | 0  |   |
| **Performance risks** | 2 |   |
| **Security risks** | 3 + 3  | Precompiles are risky, cryptography-related precompiles are even riskier. And this EIP proposes two of them at the same time. |
