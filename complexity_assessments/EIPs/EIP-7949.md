...
Link: https://eips.ethereum.org/EIPS/eip-7949
...
| **Patterns affecting pre-existing tests** | 1 | We only have add the proposed json schema to the codebase to ensure our hive simulators are still working. |
...
|-----------|--------------|:----:|
| **Total Score** | Sum of all criterion scores (0–72) | **`1`** |
