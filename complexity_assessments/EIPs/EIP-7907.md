...
| **Added opcodes** | 0 |   |
| **Modified opcodes** | 0 | Gas costs change for 6 opcodes but behavior unchanged. Per anchor definition, gas changes don't count as behavior modification. |
| **Added precompiles** | 0 |   |
| **Modified precompiles** | 0 |   |
| **Encoding changes (RLP/SSZ)** | 0 | Account state encoding changes but this anchor covers tx/block/interface encoding, not internal state. |
...
|-----------|--------------|:----:|
| **Total Score** | Sum of all anchor scores (0–72) | **`12`** |
