...
| **Patterns affecting pre-existing tests** | 1 | Pattern affects many tests but the test framework is already well prepared for this change due work already done in EIP-7623 testing. |
